...
public class ShopperInventory {
    ...
    private Map<String, InventoryItem> inventory; // Key: baseProductId
    private boolean isEquipmentEquipped = false;  // true if using basket/cart, false if using hands
    private String lastReceipt = null;  // Store last checkout receipt
    private StoreInventory storeInventory;  // Reference to store inventory

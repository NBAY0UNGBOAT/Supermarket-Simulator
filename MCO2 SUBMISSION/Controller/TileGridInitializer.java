...
/**
 * Initializes the tile grids for each floor of the supermarket.
 * Sets up tile types for walls, displays, furniture, and interactive tiles
 */
public class TileGridInitializer {
    private static final int SIZE = 22;

    /**
     * Initializes the ground floor (Floor 0) grid layout.
     * Sets up refrigerators, shelves, tables, cashiers, search kiosks, and entrance/exit.
     *
     * @param grid the TileType grid to initialize
     */
    ...
    /**
     * Initializes the upper floor (Floor 1) grid layout.
     * Sets up refrigerators, shelves, tables, and stairs for multi-floor navigation.
     *
     * @param grid the TileType grid to initialize
     */

...
public class SearchKiosk extends JPanel {
    ...
    /**
     * Constructs a new SearchKiosk for product location searching.
     * Provides an interactive interface for finding products in the supermarket.
     *
     * @param onClose callback runnable when the kiosk is closed
     */
    ...
    /**
     * Paints the search kiosk interface with product selection menus.
     * Displays current stage (type selection, item selection, or result display).
     *
    ...
    /**
     * Handles keyboard input for navigating the search kiosk interface.
     * Processes arrow keys, Enter, and Escape for menu navigation.
     *
    ...
    /**
     * Checks if the search kiosk has an active waypoint for the player to navigate to.
     *
     * @return true if a waypoint is active, false otherwise
     */
    ...
    /**
     * Clears the current waypoint for product navigation.
     */
    ...
    /**
     * Closes the search kiosk and triggers the onClose callback.
     */
    public void close() {
        if (onClose != null) {
            onClose.run();

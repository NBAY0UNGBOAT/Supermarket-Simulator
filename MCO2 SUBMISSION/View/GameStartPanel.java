...
public class GameStartPanel extends JPanel {
    ...
    /**
     * Constructs a new GameStartPanel for player registration.
     * Initializes UI components for username, age, and starting balance input.
     *
     * @param onStart callback runnable to execute when player starts the game
     */
    public GameStartPanel(Runnable onStart) {
        // Initialize game start panel with callback
        this.onStart = onStart;
        // Set layout to BorderLayout for flexible sizing
     ...
     *
     * @return the player's starting balance
     */
